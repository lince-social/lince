Protein (@protein: 0, is #chapter, #instinct, #part-of @ontology, #done) { r_BGRED8HMYDK95305QQ84MBBQFN

## Protein: the read contract
...
"- [x] `nearby` â Organs currently visible on the local network" (2026-08-04).
  ...
  **Liveness is the part to get right.** Protein subscriptions recompute off
  ...
  Deliberately NOT grouped with presence. Presence is per-keystroke and
