...
the editor's, and is not a reason to hold this one back.
...
from cost: `quantity` is added and never assigned (see the repair half), so an op carrying
...
### Visibility — what is left

#### Scoping: what a contact may see of you


#### Devices you can narrow instead of only revoking
