...
pub(crate) struct SavedDocumentViewer {
    pub workspace: u64,
    castle: DocumentViewer,
    position: [f64; 2],
    size: [f32; 2],
...
pub(crate) fn snapshot(world: &mut World, root: Entity) -> Vec<SavedDocumentViewer> {
    world
        .query::<(
            Entity,
            &ChildOf,
