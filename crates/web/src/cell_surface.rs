...
//! (`sand::render_official_widgets`) and written to
//! `<lince_data_dir>/web/sand/` at boot, then served flat at `/sand/{*path}`.
//! This module only classifies content types for that route now.
