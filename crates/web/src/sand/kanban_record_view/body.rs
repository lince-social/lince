...
pub(super) fn body() -> Markup {
    html! {
        ...
        data-on:kanban-open-view="$activeSheet = 'view'"
        ...
        data-on-signal-patch-filter="{include: /^(ui(\\.|$)|activeSheet$)/}"
    {
            ...
            .panel {
                .header {
                    ...
                    .headerActions {
                        ...
                        button.toolbarBtn type="button" id="kanban-open-view" data-on:click="$activeSheet = 'view'" { "View" }
        ...
        .sheetOverlay id="kanban-view-sheet" data-show="$activeSheet === 'view'" style="display: none" {
            button.sheetBackdrop type="button" data-close-sheet="view" data-on:click="$activeSheet = ''" {}
            .sheetPanel {
                .sheetHeader {
                    .headerMeta {
                        .headerTitle { "View options" }
                        .headerSub { "Board filters, card density, and live widget controls." }
                    }
                    .headerActions {
                        button.toolbarBtn type="button" data-close-sheet="view" data-on:click="$activeSheet = ''" { "Close" }
                    }
                }
                #kanban-view-sheet-body {}
            }
        }
