...
const WHITE_SVG: &[u8] = include_bytes!("../../../../../assets/white.svg");
const WHITE_PNG: &[u8] = include_bytes!("../../../../../assets/branco.png");
const WHITE_IN_BLACK_SVG: &[u8] = include_bytes!("../../../../../assets/white_in_black.svg");
const WHITE_IN_BLACK_PNG: &[u8] = include_bytes!("../../../../../assets/branco_no_preto.png");
const BLACK_SVG: &[u8] = include_bytes!("../../../../../assets/black.svg");
const BLACK_PNG: &[u8] = include_bytes!("../../../../../assets/preto.png");
const BLACK_IN_WHITE_SVG: &[u8] = include_bytes!("../../../../../assets/black_in_white.svg");
const BLACK_IN_WHITE_PNG: &[u8] = include_bytes!("../../../../../assets/preto_no_branco.png");
const BLACK_IN_WHITE_ICO: &[u8] = include_bytes!("../../../../../assets/black_in_white.ico");
const BLACK_IN_WHITE_ICNS: &[u8] = include_bytes!("../../../../../assets/black_in_white.icns");
