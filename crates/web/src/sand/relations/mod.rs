...
pub(crate) fn package() -> crate::domain::lince_package::LincePackage {
    let manifest = PackageManifest {
        ...
        version: "0.1.0".into(),
        description: "Directed record graph for one-way parent relations.".into(),
        details: "Graph view for records with persistent category and parent-head filters, local graph physics, and host-backed connect/disconnect relation edits.".into(),
        initial_width: 7,
        initial_height: 6,
