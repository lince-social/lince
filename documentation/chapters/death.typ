...
spend processing your online purchases and how much it could be plugged into the LNHM (Lince-Net-Hive-Mind).

Amazon is a platform for Records of item contributions, your purchases are Transfer Proposals. The rides you make
on Uber are Transfer Proposals of money for transportation from point A to B. Any automation they make inside their platforms is
limited to the data they have on you, which is a miniscule amount of your whole life (at least I hope it is). If you where to
set up hacky ways to use those platforms automatically to fit your needs, you would be doing it to every app you have, connecting them in ways they
where not meant to, possibly programming something to organize all those changing external apps. It doesn't need to be that inefficient,
you can have one central program that you can trust to work offline for you, acting just the way you want, featureful, built by many people,
...
Lince is a contribution to the need of having Lince, of having all production
possibly connected, so there is predictability in resource usage and logistics coordination.
...
It's a contribution to understanding the whole of possibilities of how you can connect with other people,
after seeing needs you didnt know others had, sparking ideas of contributions you didn't know you could make.
