...
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: 0.0 Usable by non-crazy-frog people, but still technical', '      - [ ] Creation Component - Autocomplete in each text field. Have a way for me to configure in Rust, in a hard-coded way, when typing in fields in a creation component what fields should trigger autocomplete for what tables. Example: in the creation component for the View table i should be able to type in Name or Query and search only rows of Views where any column has the same full text search part as the one im writting in that field. If click on a line of autocomplete, or if I type enter (with a current line selected by the autocomplete), all the empty fields in my Creation component should have the values of the line selected. If I then edit another field that should also trigger autocomplete, and if i hit enter in that it will also replace the value of the current input field with the searched one and the empty ones. That is the default behavior for creation components.
    ...
    ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Next Planning Talking Points', '        - [ ]
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Tasks no Servidor', '        - [x] Rodar a lince no servidor
        - [x] Integrar localmente
        - [x] Apontar pra outro lugar que não seja localmente
          - [x] Export porta na vps com https
        - [ ] Unificar versão web aqui
        - [ ] Organizar as operações pro back como um
        - [ ] Jogar essas tasks lá com um comando, deixando os dados de uma forma que de para ver em tabela com quantity -1, head (''Task: '' + title) e body (body do typst). Usar uma View que puxa dados com head like %Task%
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: New Logo Items: First Batch', '        - [/] Stickers -> Rei do Sticker: 500 (250 b&w, 250 w&b) laminated. It will be 5x5cm. | Duds
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Frequency', '        Frequency has two features to be done so we can complete it:
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Tutorial: First Steps', '        This is a document that is supposed to teach someone what Lince is.
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Extensions', '        Be able to use a View someone else made.
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: SQL Query Editor GUI', '        This could be replaced with the connector that is used for getting data into the sandbox the extension uses. If i need to select what data i want it is pretty similar to the workflow of making an sql query in a GUI-like way.
        ...
        - [ ] Maybe todo?
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Schema Evolution', '        This is a thinking task.
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Karma Refactor', '        Karma Conditions poderem ser referenciadas em outras conditions tipo kd2 + kd6.
        Garantir que seja possível ter cadeias infinitas de condições: karma: kd2 = kd6 = ks2
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Endpoint', '        - Be able to receive info about actions like changing a record Quantity, activating commands, running Karma through endpoints. That way any device can be a client, even an ESP.
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Note-taking-like', '        Ter uma forma boa de editar notas, conectando possivelmente notas de objetivos com karma, pra que cada workflow tenha sua justificativa e possa-se criar primeiro os objetivos e completar eles com os passos pra chegar lá
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Design: Profile like', '        Currently, lince feels like only a personal offline todo app. Because that''s what it currently is.
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Canvas', '        Make an expansive 2d canvas, views dragging to adjust the position.
        When im in any collection, i can drag and drop my views, resize them, and their positions and
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Collection''s Views CRUD', '        Be able to:
        - Update view''s name, query
        - Add views
        - Remove Views
        - Create Views
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Shortcut focus operation input', '        Ctrl-K will focus on it, anywhere that im in, it focuses it.
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Deterministic Simulation Testing', '        DST is amazing! The idea (I think) is to have three things:
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Configuration', '        Show configuration divided into sections, with toggle buttons, input fields so the user doesnt have to just edit a table.
        For colorschemes show the possible ones.
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Colorscheme', '        Make figma design use variables, in the figma they will set a colorschme to watch things that will use those variable names with different values for the colors in each colorscheme. In compilation, have one struct with different values for each colorscheme, make figma export those variables to use in the application.
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Transfer Proposal', '        One can create a Transference Proposal, saying they have a Contribution to make. That initial part, with their Record and a proposal of a Contribution can be enough data to be shown to the public. One doesn''t need to set what type of Counter Contribution they receive for it. Whenever the one part of the transfer is written, it is ready to be shown.
...
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Organ Management', '        Your data is called a DNA, your Lince instance is called a Cell. Many Cells form a group called an Organ. This Organ can be for your family, friends, company, party, whatever. People can use it to share part of their Needs public in this Organ, and Contribute to the Needs of the Organ. Lince is all of the Cells and Organs are working together for eachother''s Needs.
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Init: Integration', '        - [ ] Integrate with the majority of AI models, local or remote through API.
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: View Creation', '        In the HTML version, have a way to put in the Sanboxes a component that was made by an AI after a prompt.
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Karma Recommendation, Agentic and Tinkerer', '        The AI model looks at the user''s data that the user marks as ''Allowed For AI''. The Karma, Records, Transfers, etc are analysed to sugest, in the Ask mode, to automatically change, in the Agent mode, or to simply do the optimizations it think you''ll need, in Tinkerer mode.
      ...
      ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Execute single Karma with visualization on the condition being evaluated', '      Maybe a modal
    ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Command buffer', '      - [ ] The command buffer doesnt always appear. At least when running the command with Operation Input.
      - [ ] Maintain the shell''s text highlighting. Maybe using tree-sitter?
    ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Command in several languages', '      syntax highlighting and lsp (Tree-Sitter?) for Commands
    ...
    ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Digital/Real-World Maps', '      Being able to see the world or a digital space with it''s actors and needs/contributions.
    ...
    ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: 5D Views', '      3D so we can view a world. 4D so we can watch it''s history, 5D so we can compare different scenarios in the future with their simulations of different outcomes.
    ...
    ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Lince Institute', '      - [/] Hire Lawyer: AFOSC.
    ...
    ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Lynx alive in Website', '      Make a _Lynx canadensis_ 3D model inside the website. While the website is boring, the Lynx is very alive.
    ...
    ');
INSERT INTO record(quantity, head, body) VALUES (-1, 'Task: Online Shop', '      - [ ] Make an online shop managed by Lince.
