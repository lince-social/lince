...
#task("Frequency", contributors: ("@DiogoTeixeiraDEV",))[
...
// Start of integration & relations
#task(
...
#task(
  ...
  Just like rustlings, a tutorial that you code Rust to fix bugs and learn we can have Cub.
  It will teach you things and ask you to fix stuff maybe to advance forward in using Lince and creating a useful DNA.
]
#task(
  "JSON Endpoints",
  contributors: ("N1",),
...
#task(
  ...
  Caso ids em cada dna ainda se mantenham em um INT autoincremental: Ajustar Ids quando deleto algo deixo espaços vazios,
  fazer um shift pra eles se apertarem em direção ao zero, pra ficar mais fácil de digitar numeros menores.
  Mudar todos os ids que referenciam os que mudaram, em karma expressions
]
