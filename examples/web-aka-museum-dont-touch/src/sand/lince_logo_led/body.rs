...
const GRADIENT_STOPS: [(&str, &str); 12] = [
    ("0%", "#22d3ee"),
    ("14%", "#22d3ee"),
    ("14%", "#f472b6"),
    ("28%", "#f472b6"),
...
pub(super) fn body() -> Markup {
    html! {
        main id="stage" class="stage" data-mode="startup" tabindex="0" role="button" aria-label="Cycle Lince logo lighting mode" {
            div class="lockup" {
                    ...
                    defs {
                        linearGradient id="ledGradient" x1="0" y1="0" x2="1105" y2="0" gradientUnits="userSpaceOnUse" {
                            ...
                            animateTransform attributeName="gradientTransform" type="translate"
                                values="-240 0; 0 0; 240 0; -240 0" dur="4.2s" repeatCount="indefinite" {}
                        }
                    }
                    g {
