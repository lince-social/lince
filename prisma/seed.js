...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var countConfiguration, configurations, countViews, views, countRecord, records;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.configuration.count()];
                case 1:
                    countConfiguration = _a.sent();
                    if (!(countConfiguration === 0)) return [3 /*break*/, 3];
                    return [4 /*yield*/, prisma.configuration.createMany({
                            data: [
                                {
                                    quantity: 0,
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3: return [4 /*yield*/, prisma.view.count()];
                case 4:
                    countViews = _a.sent();
                    if (!(countViews === 0)) return [3 /*break*/, 6];
                    return [4 /*yield*/, prisma.view.createMany({
                            data: [
                ...
                case 5:
                    ...
                    _a.label = 6;
                case 6: return [4 /*yield*/, prisma.record.count()];
                case 7:
                    countRecord = _a.sent();
                    if (!(countRecord === 0)) return [3 /*break*/, 9];
                    return [4 /*yield*/, prisma.record.createMany({
