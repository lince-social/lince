...
- Kanban: mixed Datastar + JS state, with SSE-driven sync, local persistence, UI orchestration, and an explicit source-view plus human-named derived-view flow.
